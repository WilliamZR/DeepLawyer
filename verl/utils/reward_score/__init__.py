...
## TODO: pass arguements from the scripts to the compute_score function
def _default_compute_score(data_source, solution_str, ground_truth,extra_info=None, **kwargs):
    ...
    elif data_source in ['lighteval/MATH', 'DigitalLearningGmbH/MATH-lighteval'] or 'lighteval' in data_source:
        from . import math
        res = math.compute_score(solution_str, ground_truth)
    elif 'jec-qa-1-multi-choice' in data_source:
        from . import law
        res = law.compute_score(solution_str, ground_truth, **kwargs)
    elif data_source in [
